...
;( function ( window, document, $, undefined ) {
  ...
  $.swipebox = function( elem, options ) {
    ...
    var ui,
      ...
      html = '<div class="Swipebox-overlay" id="swipebox-overlay">\
          <div class="Swipebox-container" id="swipebox-container">\
            <div class="Swipebox-slider" id="swipebox-slider"></div>\
            <div class="Swipebox-topBar" id="swipebox-top-bar">\
              <div class="Swipebox-title" id="swipebox-title"></div>\
            </div>\
            <div class="Swipebox-bottomBar" id="swipebox-bottom-bar">\
              <div class="Swipebox-arrows" id="swipebox-arrows">\
                <button class="Swipebox-prev" id="swipebox-prev">\
                  <svg class="Icon Icon-stroked">\
                    <title>Previous</title>\
                    <use xlink:href="#Icon-left"></use>\
                  </svg>\
                </button>\
                <button class="Swipebox-next" id="swipebox-next">\
                  <svg class="Icon Icon-stroked">\
                    <title>Next</title>\
            ...
            <button class="Swipebox-close" id="swipebox-close">\
              <svg class="Icon Icon-stroked">\
                <title>Close</title>\
    ...
    plugin.init = function() {
      ...
      if ( $.isArray( elem ) ) {
        ...
        $( document ).on( 'click', selector, function( event ) {
          ...
          if ( event.target.parentNode.className === 'Swipebox-slide is-current' ) {
            return false;
          }
    ...
    ui = {
      ...
      build : function () {
        ...
        $.each( elements,  function() {
          $( '#swipebox-slider' ).append( '<div class="Swipebox-slide"></div>' );
        } );
      ...
      gesture : function () {
        ...
        bars.addClass( 'is-visible');
        $this.setTimeout();

        $( 'body' ).bind( 'touchstart', function( event ) {

          $( this ).addClass( 'touching' );
          index = $( '.Swipebox-slide' ).index( $( '.Swipebox-slide.is-current' ) );
          ...
          $( '.touching' ).bind( 'touchmove',function( event ) {
            ...
            if ( hSwipe ) {
              ...
              if ( 0 < hDistance ) {
                ...
                if ( 0 === index ) {
                  // console.log( 'first' );
                  $( '#swipebox-overlay' ).addClass( 'is-leftSpringTouch' );
                } else {
                  // Follow gesture
                  $( '#swipebox-overlay' ).removeClass( 'is-leftSpringTouch' ).removeClass( 'is-rightSpringTouch' );
                  $( '#swipebox-slider' ).css( {
              ...
              // swipe rught
                ...
                if ( elements.length === index +1 ) {
                  // console.log( 'last' );
                  $( '#swipebox-overlay' ).addClass( 'is-rightSpringTouch' );
                } else {
                  $( '#swipebox-overlay' ).removeClass( 'is-leftSpringTouch' ).removeClass( 'is-rightSpringTouch' );
                  $( '#swipebox-slider' ).css( {
                    '-webkit-transform' : 'translate3d(' + ( currentX + hDistancePercent ) +'%, 0, 0)',
      ...
      setSlide : function ( index, isFirst ) {
        ...
        $( '#swipebox-slider .Swipebox-slide' ).removeClass( 'is-current' );
        $( '#swipebox-slider .Swipebox-slide' ).eq( index ).addClass( 'is-current' );
        this.setTitle( index );
        ...
        $( '#swipebox-prev, #swipebox-next' ).removeClass( 'is-disabled' );

        if ( index === 0 ) {
          $( '#swipebox-prev' ).addClass( 'is-disabled' );
        } else if ( index === elements.length - 1 && plugin.settings.loopAtEnd !== true ) {
          $( '#swipebox-next' ).addClass( 'is-disabled' );
        }
      },
      ...
      openMedia : function ( index ) {
        ...
        slide = $( '#swipebox-slider .Swipebox-slide' ).eq( index );

        if ( ! $this.isVideo( src ) ) {
          slide.addClass( 'Swipebox-loading' );
          $this.loadMedia( src, function() {
            slide.removeClass( 'Swipebox-loading' );
            slide.html( this );
          } );
        } else {
      ...
      getNext : function () {
        var $this = this,
          src,
          index = $( '#swipebox-slider .Swipebox-slide' ).index( $( '#swipebox-slider .Swipebox-slide.is-current' ) );
        if ( index + 1 < elements.length ) {

          src = $( '#swipebox-slider .Swipebox-slide' ).eq( index ).contents().find( 'iframe' ).attr( 'src' );
          $( '#swipebox-slider .Swipebox-slide' ).eq( index ).contents().find( 'iframe' ).attr( 'src', src );
          index++;
          $this.setSlide( index );
          $this.preloadMedia( index+1 );
        } else {
          ...
          if ( plugin.settings.loopAtEnd === true ) {
            ...
            $( '#swipebox-overlay' ).addClass( 'is-rightSpring' );
            setTimeout( function() {
              $( '#swipebox-overlay' ).removeClass( 'is-rightSpring' );
            }, 500 );
          }
        }
      },
       ...
       */
      getPrev : function () {
        var index = $( '#swipebox-slider .Swipebox-slide' ).index( $( '#swipebox-slider .Swipebox-slide.is-current' ) ),
          src;
        if ( index > 0 ) {
          src = $( '#swipebox-slider .Swipebox-slide' ).eq( index ).contents().find( 'iframe').attr( 'src' );
          $( '#swipebox-slider .Swipebox-slide' ).eq( index ).contents().find( 'iframe' ).attr( 'src', src );
          ...
          $( '#swipebox-overlay' ).addClass( 'is-leftSpring' );
          setTimeout( function() {
            $( '#swipebox-overlay' ).removeClass( 'is-leftSpring' );
          }, 500 );
        }
      },
